...
export const EXTENDED_MERCHANT_PATTERNS: MerchantPattern[] = [
  ...
  // Major chains
  {
    pattern: /loblaws|no\s*frills|superstore|rcss/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Loblaws',
    confidence: 'high',
  },
  {
    pattern: /metro\s+(?!gas)/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Metro',
    confidence: 'high',
  },
  {
    pattern: /sobeys|safeway|freshco|iga\s/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Sobeys',
    confidence: 'high',
  },
  {
    pattern: /walmart\s+sup|wal-?mart\s+#\d+/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Walmart',
    confidence: 'high',
  },
  {
    pattern: /costco\s+who|costco\s+#\d+/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Costco',
    confidence: 'high',
  },
  {
    pattern: /t\s*&\s*t\s+sup|t\s+and\s+t/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'T&T Supermarket',
    confidence: 'high',
  },
  {
    pattern: /food\s*basics/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Food Basics',
    confidence: 'high',
  },
  {
    pattern: /farm\s*boy/i,
    category: SpendingCategory.GROCERIES,
  ...
  {
    pattern: /whole\s*foods/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Whole Foods',
    confidence: 'high',
  },
  {
    pattern: /voila|instacart/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Grocery Delivery',
    confidence: 'high',
  },
  {
    pattern: /save[\s-]?on[\s-]?foods/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Save-On-Foods',
    confidence: 'high',
  },
  {
    pattern: /real\s+canadian\s+sup/i,
    category: SpendingCategory.GROCERIES,
    merchantName: 'Real Canadian Superstore',
    confidence: 'high',
  },
  {
    pattern: /independent\s+grocer/i,
    category: SpendingCategory.GROCERIES,
  ...
  {
    pattern: /grocery|grocer|supermarket|marche|market/i,
    category: SpendingCategory.GROCERIES,
  ...
  {
    pattern: /tim\s*horton|tims\s/i,
    category: SpendingCategory.DINING,
    merchantName: 'Tim Hortons',
    confidence: 'high',
  },
  {
    pattern: /second\s*cup/i,
    category: SpendingCategory.DINING,
  ...
  {
    pattern: /kfc|kentucky\s*fried/i,
    category: SpendingCategory.DINING,
    merchantName: 'KFC',
    confidence: 'high',
  },
  ...
  // Casual dining
  {
    pattern: /boston\s*pizza|bp\s+rest/i,
    category: SpendingCategory.DINING,
  ...
  {
    pattern: /east\s*side\s*mario/i,
    category: SpendingCategory.DINING,
    merchantName: "East Side Mario's",
    confidence: 'high',
  },
  {
    pattern: /kelsey'?s/i,
  ...
  {
    pattern: /milestones/i,
    category: SpendingCategory.DINING,
    merchantName: 'Milestones',
    confidence: 'high',
  },
  {
    pattern: /cactus\s*club/i,
    category: SpendingCategory.DINING,
    merchantName: 'Cactus Club',
    confidence: 'high',
  },
  {
    pattern: /earls/i,
  ...
  {
    pattern: /jack\s*astor/i,
    category: SpendingCategory.DINING,
    merchantName: "Jack Astor's",
    confidence: 'high',
  },
  // Delivery apps
  {
    pattern: /skip\s*the\s*dish|skipthedish/i,
    category: SpendingCategory.DINING,
    merchantName: 'SkipTheDishes',
    confidence: 'high',
  },
  {
    pattern: /uber\s*eat/i,
    category: SpendingCategory.DINING,
  ...
  {
    pattern: /fantuan|hungry\s*panda/i,
    category: SpendingCategory.DINING,
  ...
  {
    pattern: /restaurant|resto|bistro|cafe|grill|kitchen|diner|tavern|pub\s/i,
    category: SpendingCategory.DINING,
    merchantName: 'Restaurant',
    confidence: 'medium',
  },
  {
    pattern: /pizza|sushi|thai|chinese|indian|vietnamese|korean|japanese|mexican/i,
    category: SpendingCategory.DINING,
    merchantName: 'Restaurant',
    confidence: 'medium',
  },
  {
    pattern: /bar\s+&|sports\s*bar|brew/i,
    category: SpendingCategory.DINING,
  ...
  // ========== GAS ==========
  {
    pattern: /esso|exxon/i,
    category: SpendingCategory.GAS,
    merchantName: 'Esso',
    confidence: 'high',
  },
  {
    pattern: /shell(?!\s*fish)/i,
    category: SpendingCategory.GAS,
    merchantName: 'Shell',
    confidence: 'high',
  },
  {
    ...
    pattern: /petro[\s\-]*can/i,
    category: SpendingCategory.GAS,
    merchantName: 'Petro-Canada',
    confidence: 'high',
  },
  {
    pattern: /canadian\s*tire\s*gas|ct\s*gas/i,
    category: SpendingCategory.GAS,
    merchantName: 'Canadian Tire Gas+',
    confidence: 'high',
  },
  {
    pattern: /husky\s*(?:energy|gas|oil)?/i,
    category: SpendingCategory.GAS,
    merchantName: 'Husky',
    confidence: 'high',
  },
  {
    pattern: /pioneer\s*(?:gas)?/i,
    category: SpendingCategory.GAS,
  ...
  {
    // eslint-disable-next-line no-useless-escape
    pattern: /7[\-\s]?eleven\s*gas|7-11\s*gas/i,
    category: SpendingCategory.GAS,
  ...
  },
  {
    pattern: /fas\s*gas/i,
    category: SpendingCategory.GAS,
    merchantName: 'Fas Gas',
    confidence: 'high',
  },
  {
    pattern: /domo\s*gas/i,
    category: SpendingCategory.GAS,
    merchantName: 'DOMO',
    confidence: 'high',
  },
  ...
  {
    pattern: /gas\s*station|fuel|petroleum|petrol\s/i,
    category: SpendingCategory.GAS,
  ...
  {
    pattern: /ttc|toronto\s*transit/i,
    category: SpendingCategory.OTHER,
    merchantName: 'TTC',
    confidence: 'high',
  },
  {
    pattern: /metrolinx|go\s*transit/i,
    category: SpendingCategory.OTHER,
    merchantName: 'GO Transit',
    confidence: 'high',
  },
  {
    pattern: /oct\s*transpo|oc\s*transpo/i,
    category: SpendingCategory.OTHER,
    merchantName: 'OC Transpo',
    confidence: 'high',
  },
  {
    pattern: /stm\s|societe\s*de\s*transport/i,
    category: SpendingCategory.OTHER,
    merchantName: 'STM Montreal',
    confidence: 'high',
  },
  {
    pattern: /translink/i,
  ...
  {
    pattern: /compass\s*card/i,
    category: SpendingCategory.OTHER,
    merchantName: 'Compass Card',
    confidence: 'high',
  },
  {
    pattern: /uber(?!\s*eat)/i,
  ...
  {
    pattern: /taxi|cab\s/i,
    category: SpendingCategory.OTHER,
    merchantName: 'Taxi',
    confidence: 'medium',
  },
  {
    pattern: /parking|park\s*n\s*fly|impark/i,
    category: SpendingCategory.OTHER,
  ...
  // ========== ONLINE SHOPPING ==========
  {
    pattern: /amazon|amzn|amz\s*mkt/i,
    category: SpendingCategory.ONLINE_SHOPPING,
    merchantName: 'Amazon',
    confidence: 'high',
  },
  {
    pattern: /apple\.com|itunes|apple\s*store/i,
    category: SpendingCategory.ONLINE_SHOPPING,
    merchantName: 'Apple',
    confidence: 'high',
  },
  {
    pattern: /google\s*\*|google\s*play/i,
    category: SpendingCategory.ONLINE_SHOPPING,
    merchantName: 'Google',
    confidence: 'high',
  },
  ...
  // ========== DRUGSTORES ==========
  {
    pattern: /shoppers\s*drug|sdm|beauty\s*boutique/i,
  ...
  {
    pattern: /pharmasave/i,
    category: SpendingCategory.DRUGSTORES,
    merchantName: 'PharmaChoice',
    confidence: 'high',
  },
  {
    pattern: /london\s*drugs/i,
    category: SpendingCategory.DRUGSTORES,
    merchantName: 'London Drugs',
    confidence: 'high',
  },
  {
    pattern: /jean\s*coutu/i,
    category: SpendingCategory.DRUGSTORES,
    merchantName: 'Jean Coutu',
    confidence: 'high',
  },
  {
    pattern: /pharmaprix/i,
    category: SpendingCategory.DRUGSTORES,
    merchantName: 'Pharmaprix',
    confidence: 'high',
  },
  {
    pattern: /guardian\s*pharmacy|ida\s*pharmacy/i,
    category: SpendingCategory.DRUGSTORES,
    merchantName: 'Pharmacy',
    confidence: 'high',
  },
  {
    pattern: /pharma|drugstore|rx\s/i,
    category: SpendingCategory.DRUGSTORES,
    merchantName: 'Pharmacy',
    confidence: 'medium',
  },
  ...
  {
    pattern: /disney\+|disneyplus/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'Disney+',
    confidence: 'high',
  },
  {
    pattern: /crave|bell\s*media/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'Crave',
    confidence: 'high',
  },
  ...
  {
    pattern: /apple\s*tv\+|apple\s*music/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'Apple Services',
    confidence: 'high',
  },
  {
    pattern: /youtube\s*prem/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'YouTube Premium',
    confidence: 'high',
  },
  {
    pattern: /hbo|max\s*streaming/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'Max',
    confidence: 'high',
  },
  {
    pattern: /cineplex|galaxy\s*cin|landmark\s*cin/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'Cinema',
    confidence: 'high',
  },
  {
    pattern: /xbox|playstation|psn|nintendo/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'Gaming',
    confidence: 'high',
  },
  {
    pattern: /steam|epic\s*games/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'Gaming',
    confidence: 'high',
  },
  {
    pattern: /ticketmaster|stubhub|eventbrite/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'Tickets',
    confidence: 'high',
  },
  {
    pattern: /mlse|raptors|leafs|jays|blue\s*jays/i,
    category: SpendingCategory.ENTERTAINMENT,
    merchantName: 'Sports',
    confidence: 'high',
  },
  ...
  // ========== HOME IMPROVEMENT ==========
  {
    pattern: /canadian\s*tire(?!\s*gas)/i,
  ...
  {
    pattern: /lowe'?s|rona/i,
    category: SpendingCategory.HOME_IMPROVEMENT,
    merchantName: "Lowe's/RONA",
    confidence: 'high',
  },
  {
    pattern: /home\s*hardware/i,
    category: SpendingCategory.HOME_IMPROVEMENT,
  ...
  },
  {
    pattern: /structube/i,
    category: SpendingCategory.HOME_IMPROVEMENT,
    merchantName: 'Structube',
    confidence: 'high',
  },
  {
    pattern: /the\s*brick/i,
    category: SpendingCategory.HOME_IMPROVEMENT,
    merchantName: 'The Brick',
    confidence: 'high',
  },
  {
    pattern: /leon'?s/i,
  ...
  {
    pattern: /bed\s*bath|homesense|winners/i,
    category: SpendingCategory.HOME_IMPROVEMENT,
  ...
  // ========== TRAVEL ==========
  {
    pattern: /air\s*canada|westjet|porter\s*air|flair\s*air|swoop/i,
    category: SpendingCategory.TRAVEL,
    merchantName: 'Airline',
    confidence: 'high',
  },
  {
    pattern: /united\s*air|delta\s*air|american\s*air|alaska\s*air/i,
    category: SpendingCategory.TRAVEL,
    merchantName: 'Airline',
    confidence: 'high',
  },
  {
    pattern: /marriott|hilton|hyatt|ihg|accor|wyndham/i,
    category: SpendingCategory.TRAVEL,
    merchantName: 'Hotel',
    confidence: 'high',
  },
  {
    pattern: /fairmont|four\s*seasons|ritz/i,
    category: SpendingCategory.TRAVEL,
    merchantName: 'Hotel',
    confidence: 'high',
  },
  {
    pattern: /airbnb|vrbo/i,
    category: SpendingCategory.TRAVEL,
    merchantName: 'Vacation Rental',
    confidence: 'high',
  },
  {
    pattern: /booking\.com|expedia|hotels\.com|kayak|trivago/i,
    category: SpendingCategory.TRAVEL,
    merchantName: 'Travel Booking',
    confidence: 'high',
  },
  {
    pattern: /hertz|avis|budget|enterprise|national\s*car/i,
    category: SpendingCategory.TRAVEL,
    merchantName: 'Car Rental',
    confidence: 'high',
  },
  {
    pattern: /via\s*rail|amtrak/i,
    category: SpendingCategory.TRAVEL,
    merchantName: 'Train',
    confidence: 'high',
  },
  ...
  {
    pattern: /rogers|bell\s*can|telus|shaw|videotron|cogeco/i,
    category: SpendingCategory.OTHER,
    merchantName: 'Telecom',
    confidence: 'high',
  },
  {
    pattern: /fido|koodo|virgin\s*mobile|freedom\s*mob|chatr/i,
    category: SpendingCategory.OTHER,
    merchantName: 'Mobile',
    confidence: 'high',
  },
  {
    pattern: /hydro|enbridge|toronto\s*hydro|bc\s*hydro/i,
    category: SpendingCategory.OTHER,
    merchantName: 'Utilities',
    confidence: 'high',
  },
  {
    pattern: /insurance|sunlife|manulife|desjardins\s*ins/i,
    category: SpendingCategory.OTHER,
    merchantName: 'Insurance',
    confidence: 'high',
  },
  {
    pattern: /gym|goodlife|fit4less|la\s*fitness|planet\s*fitness/i,
    category: SpendingCategory.OTHER,
    merchantName: 'Gym',
    confidence: 'high',
  },
  ...
  {
    pattern: /walmart(?!\s*sup)/i,
    category: SpendingCategory.OTHER,
    merchantName: 'Walmart',
    confidence: 'medium',
  },
  {
    pattern: /costco(?!\s*who|\s*gas)/i,
    category: SpendingCategory.OTHER,
    merchantName: 'Costco',
    confidence: 'medium',
  },
  {
    pattern: /hudson'?s\s*bay|hbc\s/i,
    category: SpendingCategory.OTHER,
